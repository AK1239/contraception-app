    ...
    getDefaultMiddleware({
      serializableCheck: {
        ...
        ignoredPaths: [
          ...
          "standardDayMethod.evaluationResult.lmpDate",
          "standardDayMethod.evaluationResult.fertileWindow",
          "standardDayMethod.evaluationResult.safeWindow",
          "standardDayMethod.evaluationResult.nextPeriod",
          "standardDayMethod.evaluationResult.recalculationDate",
          "standardDayMethod.evaluationResult.calendarDates",
          "calendarMethod.answers.lmpDate",
          "calendarMethod.evaluationResult.lmpDate",
          "calendarMethod.evaluationResult.fertileWindow",
          "calendarMethod.evaluationResult.safeWindow",
          "calendarMethod.evaluationResult.nextPeriod",
          "calendarMethod.evaluationResult.recalculationDate",
          "calendarMethod.evaluationResult.calendarDates",
        ],
      },
    }),
});
